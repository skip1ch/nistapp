  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<EventsRecord>>(
      stream: queryEventsRecord(
        queryBuilder: (eventsRecord) => eventsRecord.orderBy('date'),
      ),
      builder: (context, snapshot) {
        ...
        List<EventsRecord> searchEventsEventsRecordList = snapshot.data!;
                ...
                children: [
                            ...
                            child: Container(
                              ...
                              child: Autocomplete<String>(
                                ...
                                optionsBuilder: (textEditingValue) {
                                  ...
                                  return searchEventsEventsRecordList
                                      .map((e) => e.name)
                                      .toList()
                                      .where((option) {
                  ...
                  if (!FFAppState().searchActive)
                    Padding(
                      ...
                      child: Builder(
                        builder: (context) {
                          final eventsNoSearch =
                              searchEventsEventsRecordList.toList();

                          return ListView.builder(
                            padding: EdgeInsets.zero,
                            shrinkWrap: true,
                            scrollDirection: Axis.vertical,
                            itemCount: eventsNoSearch.length,
                            itemBuilder: (context, eventsNoSearchIndex) {
                              final eventsNoSearchItem =
                                  eventsNoSearch[eventsNoSearchIndex];
                              return Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 0.0, 0.0, 1.0),
                                child: Container(
